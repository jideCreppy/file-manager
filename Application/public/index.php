...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <h5>Free space: <?= formatSizeUnits(disk_total_space("/")); ?></h5>
                        ...
                        <?php foreach ($records->data as $record): ?>
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    ?></td>
                                <td>
                                    <form method='POST' action='delete.php'><input type='hidden' name='delete_id'
                                                                                   value="<?= $record->id; ?>">
                                        <input type='hidden' name='delete_id' value="<?= $record->id; ?>"> <input
                                                type='hidden' name='delete_name' value="<?= $record->name; ?>">
                                        <button class='btn btn-danger' id="button_delete" type='submit'>delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
